...
var fakeInbound = [
  { start: 0.00,  end: 6.00,   text: "Thanks for calling Sterling Sales Honda, Jeep, and GMC. This is Abbey — how can I help you today?" },
  { start: 6.10,  end: 11.00,  text: "Hi Abbey, I saw a 2024 Honda CR-V on your website and had a couple of questions." },
  { start: 11.10, end: 16.00,  text: "Of course! Before we dive in, can I grab your name and callback number just in case we get disconnected?" },
  { start: 16.10, end: 21.00,  text: "Sure — it's Amanda Price, and my number is 586-555-0147." },
  { start: 21.10, end: 26.00,  text: "Thanks, Amanda. Which trim or color were you looking at?" },
  { start: 26.10, end: 31.00,  text: "It was the EX-L in silver. It had leather and the upgraded audio, I think?" },
  { start: 31.10, end: 36.00,  text: "Yes, that would be the EX-L with the premium package. Let me check our stock real quick." },
  { start: 36.10, end: 42.00,  text: "Okay, thanks." },
  { start: 42.10, end: 47.00,  text: "We’ve got one in silver on the lot and another arriving Monday in black." },
  { start: 47.10, end: 53.00,  text: "Good to know. I actually got prequalified online last night — does that help speed things up?" },
  { start: 53.10, end: 58.00,  text: "It does — that puts you ahead for paperwork. Planning to finance through us?" },
  { start: 58.10, end: 64.00,  text: "Yes — no trade-in, just buying outright or through your team." },
  { start: 64.10, end: 69.00,  text: "Perfect. Did you want to come in today or tomorrow?" },
  { start: 69.10, end: 74.00,  text: "Tomorrow’s better. I’m near Lakeside Mall — are you close by?" },
  { start: 74.10, end: 79.00,  text: "Very — we’re five minutes east off Mound Road." },
  { start: 79.10, end: 84.00,  text: "Awesome. Do you have anything open mid-morning?" },
  { start: 84.10, end: 89.00,  text: "We’ve got a 10:45 with Howie. He’ll have the EX-L and your prequal info ready." },
  { start: 89.10, end: 94.00,  text: "Perfect. Should I bring anything else with me?" },
  { start: 94.10, end: 99.00,  text: "Just your ID and insurance. You’ll also get a confirmation text and email." },
  { start: 99.10, end: 105.00, text: "Sounds good. I’ll watch for those. Thanks again for all the help, Amy." },
  { start: 105.10,end: 112.00, text: "You got it, Amanda. We’ll see you tomorrow at 10:45. Have a great day!" }
];

var fakeInboundSummary =
  "Amanda Price called Sterling Sales after viewing a 2024 Honda CR-V EX-L online. She asked about availability, confirmed interest in the silver model with leather and premium audio, and mentioned she had already completed prequalification online. Amy confirmed the vehicle was in stock, collected Amanda’s contact info, and scheduled a 10:45 a.m. appointment with Howie. Amanda was advised to bring ID and insurance, and will receive a confirmation by text and email.";


var fakeOutbound = [
  { start: 0.00,  end: 6.00,   text: "Hi Amanda, this is Howie from Sterling Sales Honda, Jeep, and GMC — calling with some great news." },
  { start: 6.10,  end: 11.00,  text: "Hi Howie! I’ve been hoping to hear from you." },
  { start: 11.10, end: 17.00,  text: "Just spoke with our finance department — your application was approved for the 2024 CR-V EX-L." },
  { start: 17.10, end: 23.00,  text: "That’s amazing, thank you! What’s the next step?" },
  { start: 23.10, end: 29.00,  text: "Next step is scheduling a time for you to come in, finalize the paperwork, and handle the down payment." },
  { start: 29.10, end: 35.00,  text: "Sounds good. I should be free tomorrow after 11 a.m." },
  { start: 35.10, end: 41.00,  text: "We have a 12:30 slot open. That gives us time to walk through everything and answer questions." },
  { start: 41.10, end: 47.00,  text: "Perfect — let’s do 12:30. Do I need to bring anything?" },
  { start: 47.10, end: 52.00,  text: "Just your ID, proof of insurance, and the down payment method we discussed." },
  { start: 52.10, end: 58.00,  text: "I’ll bring my debit card and a printed insurance copy, just in case." },
  { start: 58.10, end: 64.00,  text: "That works perfectly. We’re at Mound and 17 Mile — same location as your test drive." },
  { start: 64.10, end: 70.00,  text: "Yep, I remember. Should I ask for you at the front?" },
  { start: 70.10, end: 76.00,  text: "Yep — just let the front desk know you're here to meet Howie. I’ll come grab you." },
  { start: 76.10, end: 82.00,  text: "Awesome. Will I get a text or anything confirming the time?" },
  { start: 82.10, end: 88.00,  text: "Yes — you’ll get a confirmation text and email in just a few minutes." },
  { start: 88.10, end: 94.00,  text: "Got it. And we’re going to go over warranty stuff too, right?" },
  { start: 94.10, end: 99.00,  text: "Absolutely. We’ll review that and the service add-ons before you sign." },
  { start: 99.10, end: 105.00, text: "Cool. I think I’m all set then — looking forward to it." },
  { start: 105.10,end: 111.00, text: "Same here. Congrats again, Amanda — we’ll see you tomorrow at 12:30." },
  { start: 111.10,end: 118.00, text: "Thanks again, Howie. I’ll be there!" }
];


var fakeOutboundSummary =
  "Howie from Sterling Sales called Amanda Price to confirm that her financing for the 2024 Honda CR-V EX-L had been approved. " +
  "They scheduled a 12:30 p.m. appointment the next day to finalize paperwork and make the down payment. " +
  "Amanda was instructed to bring her ID, proof of insurance, and debit card. Howie confirmed the dealership location and that she’d receive a text and email confirmation. " +
  "They also agreed to review warranty options during the appointment.";
...
CVQS_QUEUE_ROWS_BY_NUM["302"] = [
  `<tr><td>Today, 1:46 pm</td><td>Tucker Jones</td><td>(989) 555-0128</td><td>248-436-3443</td><td>6:17</td><td>201</td><td>201</td><td>Emma Johnson</td><td>1:28</td><td>Orig: Bye</td><td>Connect</td><td class="cvqs-action-cell"></td></tr>`,
  `<tr><td>Today, 1:41 pm</td><td>Liam Nguyen</td><td>(810) 555-0100</td><td>248-436-3449</td><td>5:29</td><td>202</td><td>202</td><td>Liam Turner</td><td>8:06</td><td>Orig: Bye</td><td>Connect</td><td class="cvqs-action-cell"></td></tr>`,
  `<tr><td>Today, 1:37 pm</td><td>Maya Brooks</td><td>(517) 555-0126</td><td>248-436-3449</td><td>1:01</td><td>200</td><td>200</td><td>Abbey Palmer</td><td>2:05</td><td>Term: Bye</td><td>Connect</td><td class="cvqs-action-cell"></td></tr>`,
  `<tr><td>Today, 1:35 pm</td><td>Jack Burton</td><td>(517) 555-0148</td><td>(313) 995-9080</td><td>0:42</td><td>201</td><td>201</td><td>Emma Johnson</td><td>7:22</td><td>Orig: Bye</td><td>Connect</td><td class="cvqs-action-cell"></td></tr>`,
  `<tr><td>Today, 1:35 pm</td><td>Sarah Patel</td><td>(248) 555-0196</td><td>248-436-3443</td><td>1:57</td><td>200</td><td>200</td><td>Abbey Palmer</td><td>3:24</td><td>Orig: Bye</td><td>Connect</td><td class="cvqs-action-cell"></td></tr>`
];
...
CVQS_QUEUE_ROWS_BY_NUM["303"] = [
  `<tr><td>Today, 1:30 pm</td><td>Chloe Bennet</td><td>(313) 555-0120</td><td>248-436-3443</td><td>5:21</td><td>230</td><td>230</td><td>Sophia Anderson</td><td>6:11</td><td>Orig: Bye</td><td>Connect</td><td class="cvqs-action-cell"></td></tr>`,
  `<tr><td>Today, 11:41 am</td><td>Elizabeth Li</td><td>(313) 555-8471</td><td>(313) 995-9080</td><td>1:23</td><td>231</td><td>231</td><td>Evelyn Lewis</td><td>2:17</td><td>Term: Bye</td><td>Connect</td><td class="cvqs-action-cell"></td></tr>`,
  `<tr><td>Today, 09:56 am</td><td>Rory Davis</td><td>(313) 555-0179</td><td>(313) 995-9080</td><td>1:01</td><td>230</td><td>230</td><td>Sophia Anderson</td><td>8:17</td><td>Orig: Bye</td><td>Connect</td><td class="cvqs-action-cell"></td></tr>`
];
...
CVQS_QUEUE_ROWS_BY_NUM["301"] = [
  `<tr><td>Today, 11:22 am</td><td>JR Knight</td><td>248-555-0144</td><td>248-436-3443</td><td>3:49</td><td>202</td><td>202</td><td>Liam Turner</td><td>8:35</td><td>Term: Bye</td><td>Connect</td><td class="cvqs-action-cell"></td></tr>`,
  `<tr><td>Today, 11:18 am</td><td>Sarah Patel</td><td>(248) 555-0196</td><td>(313) 995-9080</td><td>2:22</td><td>211</td><td>211</td><td>Chad Sanders</td><td>17:29</td><td>Orig: Bye</td><td>Connect</td><td class="cvqs-action-cell"></td></tr>`,
  `<tr><td>Today,
td><td>Term: Bye</td><td>Connect</td><td class="cvqs-action-cell"></td></tr>`,
  `<tr><td>Today, 1:58 pm</td><td>Ava Chen</td><td>(313) 555-0151</td><td>248-436-3443</td><td>1:01</td><td>211</td><td>211</td><td>Chad Sanders</td><td>5:22</td><td>Orig: Bye</td><td>Connect</td><td class="cvqs-action-cell"></td></tr>`,
  ...
  `<tr><td>Today, 1:50 pm</td><td>Raj Patel</td><td>(810) 555-0187</td><td>(313) 995-9080</td><td>4:24</td><td>210</td><td>210</td><td>Mike Jones</td><td>5:51</td><td>Term: Bye</td><td>Connect</td><td class="cvqs-action-cell"></td></tr>`
];
...
function openQueueNotesPopover(anchorEl, initial) {
  ...
  pop.innerHTML = `
    ...
    <div style="display:grid;grid-template-columns:100px 1fr;gap:10px 12px;align-items:center">
      ...
      <textarea id="qn2-text" rows="4" style="width:100%;padding:1px;border:1px solid #cfd3d7;border-radius:4px;resize:vertical"></textarea>
    </div>
...
const isAgentStatsPage = () =>
  ...
  // === Real Data from user ===
  const CVAS_INBOUND = {
  '200': { CH: 5, TT: '18:25', ATT: '18:25' },
  '201': { CH: 3, TT: '07:21', ATT: '07:21' },
  '202': { CH: 8, TT: '31:25', ATT: '31:25' },
  '204': { CH: 1, TT: '01:21', ATT: '01:21' },
  '210': { CH: 2, TT: '04:39', ATT: '04:39' },
  '211': { CH: 3, TT: '07:54', ATT: '07:54' },
  '212': { CH: 1, TT: '02:41', ATT: '02:41' },
  '222': { CH: 2, TT: '06:15', ATT: '06:15' },
  '230': { CH: 2, TT: '06:22', ATT: '06:22' },
  '231': { CH: 1, TT: '01:23', ATT: '01:23' },
  '240': { CH: 1, TT: '00:57', ATT: '00:57' },
};
...
Object.assign(g.CVAS_CALLS_INBOUND_BY_AGENT, {
  ...
  "200": [
    `<tr><td>Today, 1:37 pm</td><td>Maya Brooks</td><td>(517) 555-0126</td><td>248-436-3449</td><td>1:01</td><td>200</td><td>200</td><td>Abbey Palmer</td><td>2:05</td><td>Term: Bye</td><td>Connect</td><td class="cvas-action-cell">${actionIcons}</td></tr>`,
    `<tr><td>Today, 1:35 pm</td><td>Sarah Patel</td><td>(248) 555-0196</td><td>248-436-3443</td><td>1:57</td><td>200</td><td>200</td><td>Abbey Palmer</td><td>3:24</td><td>Orig: Bye</td><td>Connect</td><td class="cvas-action-cell">${actionIcons}</td></tr>`,
    `<tr><td>Today, 10:27 am</td><td>Ruby Foster</td><td>(248) 555-0102</td><td>248-436-3449</td><td>4:21</td><td>200</td><td>200</td><td>Abbey Palmer</td><td>4:16</td><td>Orig: Bye</td><td>Connect</td><td class="cvas-action-cell">${actionIcons}</td></tr>`,
    `<tr><td>Today, 10:23 am</td><td>Monica Alvarez</td><td>(989) 555-0113</td><td>248-436-3443</td><td>2:49</td><td>200</td><td>200</td><td>Abbey Palmer</td><td>1:52</td><td>Term: Bye</td><td>Connect</td><td class="cvas-action-cell">${actionIcons}</td></tr>`,
    `<tr><td>Today, 08:16 am</td><td>Leif Hendricksen</td><td>517-555-0162</td><td>(313) 995-9080</td><td>8:17</td><td>200</td><td>200</td><td>Abbey Palmer</td><td>2:27</td><td>Term: Bye</td><td>Connect</td><td class="cvas-action-cell">${actionIcons}</td></tr>`
  ],

  "201": [
    `<tr><td>Today, 1:46 pm</td><td>Tucker Jones</td><td>(989) 555-0128</td><td>248-436-3443</td><td>6:17</td><td>201</td><td>201</td><td>Emma Johnson</td><td>1:28</td><td>Orig: Bye</td><td>Connect</td><td class="cvas-action-cell">${actionIcons}</td></tr>`,
    `<tr><td>Today, 1:35 pm</td><td>Jack Burton</td><td>(517) 555-0148</td><td>(313) 995-9080</td><td>0:42</td><td>201</td><td>201</td><td>Emma Johnson</td><td>7:22</td><td>Orig: Bye</td><td>Connect</td><td class="cvas-action-cell">${actionIcons}</td></tr>`,
    `<tr><td>Today, 08:08 am</td><td>Coco LaBelle</td><td>(989) 555-0672</td><td>248-436-3443</td><td>0:22</td><td>201</td><td>201</td><td>Emma Johnson</td><td>5:55</td><td>Orig: Bye</td><td>Connect</td><td class="cvas-action-cell">${actionIcons}</td></tr>`
  ],

  "202": [
    `<tr><td>Today, 1:41 pm</td><td>Liam Nguyen</td><td>(810) 555-0100</td><td>248-436-3449</td><td>5:29</td><td>202</td><td>202</td><td>Liam Turner</td><td>8:06</td><td>Orig: Bye</td><td>Connect</td><td class="cvas-action-cell">${actionIcons}</td></tr>`,
    `<tr><td>Today, 11:22 am</td><td>JR Knight</td><td>248-555-0144</td><td>248-436-3443</td><td>3:49</td><td>202</td><td>202</td><td>Liam Turner</td><td>8:35</td><td>Term: Bye</td><td>Connect</td><td class="cvas-action-cell">${actionIcons}</td></tr>`,
    `<tr><td>Today, 10:58 am</td><td>Lola Turner</td><td>517-555-0170</td><td>248-436-3449</td><td>4:47</td><td>202</td><td>202</td><td>Liam Turner</td><td>1:24</td><td>Orig: Bye</td><td>Connect</td><td class="cvas-action-cell">${actionIcons}</td></tr>`,
    `<tr><td>Today,